...
export const DREAMS = [...animals, ...bodyMoney, ...spiritLovePerson, ...actionNature, ...objectEtc, ...peoplePlaces, ...emotionMisc, ...misc8, ...animals2, ...bodyObject2, ...action2, ...naturePlace2, ...animalsPlaces3, ...objectBody3, ...misc15];
